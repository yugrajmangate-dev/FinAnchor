    ...
    datasets: [
      {
        ...
        backgroundColor: 'rgba(0, 212, 126, 0.75)',
        borderRadius: 8,
        hoverBackgroundColor: '#00d47e',
      },
      {
        label: 'Expenses',
        data: [35000, 36000, 35500, 37000, 38000, 39000],
        backgroundColor: 'rgba(244, 80, 80, 0.7)',
        borderRadius: 8,
        hoverBackgroundColor: '#f45050',
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        backgroundColor: ['#5e82f4', '#e72a3b', '#a855f7', '#f59e0b'],
        borderColor: '#16172b',
        borderWidth: 3,
        hoverOffset: 8,
      },
    ...
    datasets: [
      {
        ...
        borderColor: '#5e82f4',
        backgroundColor: 'rgba(94, 130, 244, 0.12)',
        borderWidth: 2.5,
        fill: true,
        pointBackgroundColor: '#5e82f4',
        pointBorderColor: '#0e0e19',
      ...
      },
      {
        ...
        borderColor: '#e72a3b',
        backgroundColor: 'rgba(231, 42, 59, 0.1)',
        borderWidth: 2.5,
        fill: true,
        pointBackgroundColor: '#e72a3b',
        pointBorderColor: '#0e0e19',
        pointBorderWidth: 2,
        pointRadius: 4,
      },
  ...
  const chartOptions = {
    ...
    scales: {
      y: {
        ...
        ticks: { font: { size: 11 }, color: '#727b9a' },
